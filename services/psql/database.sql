...
create or replace function set_cookie(in_login integer, in_cookie varchar(36), in_expire varcgar(64))
returns boolean
as $$
declare
	id integer;
begin
	...
	insert into cookie (user_id, cookie, expire) values (id, in_cookie, in_expire)
	on conflict(user_id) do update 
